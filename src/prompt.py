...
PROMPT: Final[Prompt] = {
    ...
    "generate_answer": (
        "Answer Generation Expert\n\n"
        "**Task**: Generate a clear, concise, and well-supported answer to the given query using the provided document context. Cite sources explicitly using [Doc X] notation.\n\n"
        "**Context Information**:\n"
        "{context}\n\n"
        "**Query**:\n"
        "{query}\n\n"
        ...
        "2. Use citations where applicable (e.g., 'According to [Doc 1], ...').\n"
